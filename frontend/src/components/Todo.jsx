...
const Todo = ({ todo, index, updateTodo, completeTodo, removeTodo }) => {
    return (
        <div
        className="todo"
                ...
                <div className='flex flex-row w-full justify-between p-4 text-gray-800'>
                    ...
                    <div className='flex flex-row gap-5 ml-16'>                 
                        ...
                        <button onClick={() => completeTodo(index)}>
                            <input id="checkbox-table-search-2" type="checkbox" className="mt-1 w-5 h-5 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
